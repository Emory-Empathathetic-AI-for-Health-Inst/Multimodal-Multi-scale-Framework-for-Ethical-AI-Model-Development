...
from post_processing import curated_text_postprocessing
...
def parse_umls_marked_notes(umls_marked_file_paths, df_labels=None):
    ...
    # text cleaning: removign duplicate sentences within and across intervals for the same patient
    df_curated = curated_text_postprocessing(df_curated)
