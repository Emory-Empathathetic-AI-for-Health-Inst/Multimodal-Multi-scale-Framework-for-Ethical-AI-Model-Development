...
| `unified/tools/harmonization/radiology/PIQUALvsMRQy_codes/` | `multimodal-grant-main-branch/PIQUALvsMRQy_codes/` + `multimodal-grant-side-branch/Harmonization/Radiology/PIQUALvsMRQy_codes/` | Both | canonicalized (copied via side harmonization path after equivalence check) | `diff -qr --exclude=.git` status 0 |
| `unified/tools/harmonization/radiology/HITI-Preproc/` | `multimodal-grant-side-branch/Harmonization/Radiology/HITI-Preproc/` | Side | copied (branch-only harmonization variant) | Not identical to canonical `unified/tools/data_quality/hiti_preproc/` due metadata/layout differences |
| `unified/tools/harmonization/radiology/Niffler_2/` | `multimodal-grant-side-branch/Harmonization/Radiology/Niffler_2/` | Side | copied (branch-only harmonization variant) | Not identical to canonical `unified/tools/data_quality/niffler/` (e.g., `modules_2` layout) |